...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Edit Subject', ENT_QUOTES, 'UTF-8'); ?></title>
    <link
            ...
            <div class="col-lg-6">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Update the selected subject and category type.</p>
                    </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form method="POST" action="<?= htmlspecialchars($baseUrl . '/subjects/update', ENT_QUOTES, 'UTF-8'); ?>">
