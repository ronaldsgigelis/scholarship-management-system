...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Subjects', ENT_QUOTES, 'UTF-8'); ?></title>
    <link
    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Manage subject names and category types.</p>
            </div>
            <div class="d-flex gap-2">
                <a href="<?= htmlspecialchars($baseUrl . '/', ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-outline-secondary">Home</a>
                <a href="<?= htmlspecialchars($baseUrl . '/subjects/create', ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary">Create Subject</a>
            </div>
        </div>
                                ...
                                <?php foreach ($subjects as $subject): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a
                                                    href="<?= htmlspecialchars($baseUrl . '/subjects/edit?id=' . (int) $subject['id'], ENT_QUOTES, 'UTF-8'); ?>"
                                                ...
                                                <form
                                                    method="POST"
                                                    action="<?= htmlspecialchars($baseUrl . '/subjects/delete', ENT_QUOTES, 'UTF-8'); ?>"
