...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Edit Stipend Period', ENT_QUOTES, 'UTF-8'); ?></title>
    <link
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        <h1 class="h3 mb-1">Edit Stipend Period</h1>
                        <p class="text-muted mb-0">Update the selected year, period, and period group.</p>
                    </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <form method="POST" action="<?= htmlspecialchars($baseUrl . '/stipend-periods/update', ENT_QUOTES, 'UTF-8'); ?>">
