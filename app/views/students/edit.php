...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Edit Student', ENT_QUOTES, 'UTF-8'); ?></title>
    <link
            ...
            <div class="col-lg-7">
                <div class="d-flex justify-content-between align-items-center mb-4">
                    <div>
                        ...
                        <p class="text-muted mb-0">Update student information, personal code, and assigned group.</p>
                    </div>
                ...
                <?php if (! $hasGroups): ?>
                    <div class="alert alert-warning">Groups must exist before updating a student.</div>
                <?php endif; ?>

                <div class="card shadow-sm">
                    <div class="card-body">
                        <form method="POST" action="<?= htmlspecialchars($baseUrl . '/students/update', ENT_QUOTES, 'UTF-8'); ?>">
                            ...
                            <div class="d-flex gap-2">
                                <button type="submit" class="btn btn-primary" <?= $hasGroups ? '' : 'disabled'; ?>>Update Student</button>
