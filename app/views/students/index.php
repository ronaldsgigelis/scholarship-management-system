...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Students', ENT_QUOTES, 'UTF-8'); ?></title>
    <link
    ...
    <div class="container py-5">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Manage students with first name, last name, and personal code.</p>
            </div>
            <div class="d-flex gap-2">
                <a href="<?= htmlspecialchars($baseUrl . '/', ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-outline-secondary">Home</a>
                <a href="<?= htmlspecialchars($baseUrl . '/students/create', ENT_QUOTES, 'UTF-8'); ?>" class="btn btn-primary">Create Student</a>
            </div>
        </div>
                            ...
                            <tbody>
                                <?php foreach ($students as $student): ?>
                                    <tr>
                                        ...
                                        <td><?= htmlspecialchars($student['personal_code'], ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td><?= htmlspecialchars($student['group_name'], ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td><?= htmlspecialchars($student['created_at'], ENT_QUOTES, 'UTF-8'); ?></td>
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a
                                                    href="<?= htmlspecialchars($baseUrl . '/students/edit?id=' . (int) $student['id'], ENT_QUOTES, 'UTF-8'); ?>"
                                                ...
                                                <form
                                                    method="POST"
                                                    action="<?= htmlspecialchars($baseUrl . '/students/delete', ENT_QUOTES, 'UTF-8'); ?>"
